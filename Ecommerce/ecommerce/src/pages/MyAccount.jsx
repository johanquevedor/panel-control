...
function MyAccount() {
  ...
  useEffect(() => {
    ...
    // Obtener el primer usuario en la lista de datos almacenados
  ...
  const handleLogout = () => {
    // Limpiar los datos almacenados y redirigir al usuario a la página de inicio de sesión
  ...
  return (
    <div className="MyAccountPage">
      <div className="ca-profile">
        <div className="ca-profile-image">
          <FontAwesomeIcon icon={faUser} className="ca-user-icon" />
        </div>
        <h2 className= "usernamemyaccount">{userName}</h2>
      </div>
